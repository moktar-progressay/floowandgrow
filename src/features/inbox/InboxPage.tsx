...
import { Archive, Inbox as InboxIcon, OpenInNew, Refresh, TaskAlt } from '@mui/icons-material';
...
export function InboxPage({ messages, connected, loading, error, onConnect, onRefresh, onArchive, onCreateTask }: { messages: GoogleMessage[]; connected: boolean; loading: boolean; error?: string; onConnect: () => void; onRefresh: () => void; onArchive: (message: GoogleMessage) => void; onCreateTask: (message: GoogleMessage) => void }) {
  return <>
