...
import { Button, ButtonBase, Dialog, DialogActions, DialogContent, DialogTitle, IconButton, LinearProgress, Stack, TextField, Tooltip, Typography } from '@mui/material';
import { Add, ChevronRight, DeleteOutline, Edit, FolderOpen } from '@mui/icons-material';
...
function EditableProjectCard({ project, progress, summary, onOpen, onSave, onDelete }: { project: FocusProject; progress: number; summary: string; onOpen: () => void; onSave: (name: string, colour: string) => Promise<void>; onDelete: () => void }) {
  ...
  return <SurfaceCard contentSx={{ p: '0 !important' }}>
